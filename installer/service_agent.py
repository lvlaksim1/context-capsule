...
def validate_service_snapshot(files: dict[str, str]) -> list[str]:
    ...
    if manifest is None:
        ...
        required_flags = {
            ...
            "live_bounded_delegation_return_required": "bounded live delegation must automatically return to its caller",
            "delegation_preserves_commitment_owner": "bounded delegation must preserve caller commitment ownership",
            "explicit_handoff_required_for_responsibility_transfer": "responsibility transfer requires explicit handoff",
            "responsibility_authority_orthogonal": "responsibility and authority must remain orthogonal",
            "handoff_requires_target_acceptance": "explicit handoff requires target acceptance",
            "delegated_authority_attenuation_required": "delegated authority must attenuate",
            "authority_root_provenance_required": "nested delegation must preserve root authority provenance",
            "subdelegation_inherits_constraints": "subdelegation must inherit constraints",
